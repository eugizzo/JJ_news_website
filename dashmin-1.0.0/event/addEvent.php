...
<div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2 text-primary"></i>Post Event</a>
                        <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                            <a href="#" class="dropdown-item active"><i class="fa fa-plus-circle me-2 text-primary"></i>Add New Event</a>
        ...
        <div class="content">
            ...
            <div class="col-sm-6 " style="padding-top: 10px;">
                <div class="bg-light rounded h-100 p-4">
                    <h3 class="mb-4" style="color: red;">Add Event</h3>
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInputs"
                            placeholder="published by" name="uploaded_by">
                        <label for="floatingInput">published by</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="date" class="form-control" id="floatingInputss"
                            placeholder="Date" name="date">
                        <label for="floatingInput">Date</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInputsss"
                            placeholder="location" name="location">
                        <label for="floatingInput">Location</label>
                    </div>
                    <button type="submit" name="submit" class="btn btn-primary m-2">Post Event</button>
                    </form>
                </div>
            </div>
            <div class="col-sm-3 " style="background-color: #f3f6f9;"></div>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        ...
                        Distributed By <a class="border-bottom" href="://themewagon" target="_blank">jehovahjireh choir</a>
                        </div>
                    </div>
                </div>
            </div>
