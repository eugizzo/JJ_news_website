...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Post Event</a>
                <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                    <a href="addEvent.php" class="dropdown-item"><i class="fa fa-plus-circle me-2 text-primary"></i>Add New Event</a>
                    <a href="#" class="dropdown-item active"><i class="fa fa-file me-2 text-primary"></i>Event List</a>
        ...
        <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                ...
                <a href="#" class="dropdown-item"><i class="fa fa-file me-2 text-primary"></i>UserList</a>
           ...
           <div class="col-sm-1"></div>
            <div class="col-sm-10 "style="padding-top: 15px;">
                <div class="bg-light rounded h-100 p-4">
                    <h3 class="mb-4" style="padding-top: 15px;"><i>List of user</i></h3>
...
foreach($feching as $key => $event)
  ...
  <tr>
        ...
        <th scope="row"><?php echo $i ?></th>
            ...
            <td>
            <a href="edit.php?id=<?=$event->id; ?>" style="padding-right: 10px;"><img src="../img/edit.png" style="width:20px; height:auto;"></a>
            <a href="deleteUser.php?id=<?=$event->id; ?>" onclick="return confirm('Are you sure you want to delete this user  with permission permanently? click Ok to continue or click Cancel')"><img src="../img/delete.png" style="width:30px; height:auto"></a>
             </td>
      </tr>
