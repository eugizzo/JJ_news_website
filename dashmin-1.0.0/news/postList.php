    ...
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                <a href="post.html" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2 text-primary"></i>Post News</a>
                <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                    <a href="postNews.php" class="dropdown-item"><i class="fa fa-plus-circle me-2 text-primary"></i>Add News </a>
                    <a href="#" class="dropdown-item active"><i class="fa fa-file me-2 text-primary"></i>News list</a>
        ...
        <div class="nav-item dropdown">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle " data-bs-toggle="dropdown"><i class="fa fa-user-circle me-2 text-primary"></i>Our songs</a>
                        <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
           ...
           <div class="col-sm-1"></div>
            <div class="col-sm-10 "style="padding-top: 15px;">
                <div class="bg-light rounded h-100 p-4">
                    <!-- <h3 class="mb-4" style="padding-top: 15px;"><i>List of Post</i></h3> -->
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h5 class="mb-0" style="padding-top: 15px;"><i>List of Post</i></h5>
                        <a href="postNews.php"><i class="fa fa-plus-circle me-2 text-primary"></i>Add News</a>
                    </div>
                    <div class="table-responsive">
                        ...
                        <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="text-primary">publisher</th>
                                    ...
                                    <th scope="col" class="text-primary" style="width:60px;">action</th>
                                </tr>
                            </thead>
     ...
     <tr>
        ...
        <th scope="row"><?php echo $i ?></th>
            ...
            <td><?=$files->title; ?></td>
             ...
             <td><?=$files->date; ?></td>
            <td>
            <a href="edit.php?id=<?=$file->id; ?>" style="padding-right: 10px;"><img src="../img/edit.png" style="width:20px; height:auto;"></a>
            <a href="deleteUser.php?id=<?=$file->id; ?>" onclick="return confirm('Are you sure you want to delete this user  with permission permanently? click Ok to continue or click Cancel')"><img src="../img/delete.png" style="width:30px; height:auto"></a>
             </td>
      </tr>
