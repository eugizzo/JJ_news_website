 ...
 <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2 text-primary"></i>Post Event</a>
                        <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                            <a href="../adduser/adduser.php" class="nav-item nav-link active"><i class="fa fa-plus-circle me-2 text-primary"></i> Add Users</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                            <a href="../gallery/insertGallery" class="nav-item nav-link "><i class="fa fa-plus-circle me-2 text-primary"></i> Add Gallery</a>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-user-circle me-2 text-primary"></i>Advatising</a>
                        <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                            <a href="#" class="nav-item nav-link active"><i class="fa fa-plus-circle me-2 text-primary"></i> Add </a>
                            <a href="list.php" class="dropdown-item"><i class="fa fa-file me-2 text-primary"></i>List</a>
        ...
        <div class="content">
            ...
            <div class="col-sm-6 " style="padding-top: 10px;">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4">Add Advatsiment</h6>
