 ...
 <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-user-circle me-2 text-primary"></i>Our songs</a>
                        <div class="dropdown-menu bg-transparent border-0" style="padding-left: 30px;">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2 text-primary"></i>Pages</a>
        ...
        <div class="content">
            ...
            <div class="col-sm-6 bg-light" style="padding-top: 30px; padding-bottom: 80px;">
                <div class="bg-success rounded h-100 p-4" style="padding-top: 30px;">
                    <h3 class="mb-4 text-white" style="padding-top: 30px;">Add song on album</h3>
