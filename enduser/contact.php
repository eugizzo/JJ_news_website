            ...
            <div class="container">
                ...
                <div class="row -pt-12">
                    <div class="col-12">
                        ...
                        <p class="text-primary">Please find below contact details and contact us today</p>
                    </div>
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="detaills/Comment.php" method="POST" novalidate="novalidate">
                            <div class="row">
                                <div class="col-12">
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>cjehovajireh1998@gmail.com</h3>
